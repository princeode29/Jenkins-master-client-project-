...
wget https://raw.githubusercontent.com/princeode29/Jenkins-master-client-project-/refs/heads/maven-sonarqube-nexus-jenkins/settings.xml -P /home/jenkinsmaster/.m2/
